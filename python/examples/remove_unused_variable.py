...
from syntax_tree import ASTFactory, ASTFinder, ASTRewriter, ASTShower, ASTProcessor, ASTNodeType
...
def remove_unused_variable_using_refactor_method(node_type: type[ASTNodeType]):
...
def remove_unused_variable_low_level(node_type: type[ASTNodeType]):
