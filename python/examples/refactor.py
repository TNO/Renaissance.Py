...
def refactor_with_nested_compositions(args):
    ...
    result = ASTFinder.find_all(atu,simple).to_list()
    print(result)
    ...
    pattern2 = pattern_factory.create(
'''
print1($a, $b, $c)
print2($a, $b, $c)
print3($a, $b, $c)
''')
    ...
    print(ast.dump(pattern1[0].node))
    ...
    while atu:
        ...
        # (find_all(atu, [simple]).flat_map(lambda n: Stream(n))
