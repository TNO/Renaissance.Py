...
class TestTaut2Unittest:
    ...
    @pytest.mark.parametrize("input_code, expected_code", [
        ...
        ('self.assertEqual(emrwxread.method_called(0))', 'self.assertEqual(self.emrwxread.method_called(0))')
    ])
    ...
    @pytest.mark.parametrize("input_code, expected_code", [
        (tst_code.taut_code, tst_code.result_code)
    ])
    ...
    @pytest.mark.parametrize("input_code, insert_code", [
        (tst_insert.input_code, tst_insert.insert_code)
    ])
    ...
    @pytest.mark.parametrize("input_code, expected_code", [
        (tst_class.set_up, tst_class.new_set_up)
    ])
    ...
    @pytest.mark.parametrize("input_code, expected_code", [
        (tst_class.tear_down, tst_class.new_tear_down)
    ])
