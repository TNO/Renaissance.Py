...
class TestRefactorExamplesDifferentStyles:
    def example_add_comment_and_commit(self,factory, pattern_factory):
    ...
    def example_replace_old_by_fancy_new(self,factory, pattern_factory):
    ...
    def example_use_ast_kind_finder(self,factory, _):
    ...
    def example_use_ast_function_finder(self,factory, _):
        # Create the translation unit from the provided code or example code
        atu = factory.create_from_text(example_code, 'test.c')
        # Create an ASTRewriter for the translation unit
        rewriter = ASTRewriter(atu)
