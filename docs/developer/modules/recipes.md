...
all, silently delete any comments inside the body. See python-ast-known-limitations.md item 1 for the full
...
combined with the rewrite dominance/suppression gap in python-ast-known-limitations.md item 2, corrupted the
